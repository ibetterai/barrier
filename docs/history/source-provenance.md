...
- vector-editor export metadata uses neutral filenames; and
- every snapshot includes the current public audit workflow and its tests.

The retained upstream binary baselines and their licenses are documented in
[inherited binary provenance](inherited-binary-provenance.md).

Legacy commits, pull-request references, issue edit history, comments,
workflow logs, checks, and binary release assets are not part of the
reconstructed repository. Historical commit dates therefore reflect the
