...
static const KeyID		kKeySpotlight		= 0xE0BE;	/* Spotlight key */
static const KeyID		kKeyDictation		= 0xE0BF;	/* Dictation key */
static const KeyID		kKeyDoNotDisturb	= 0xE0C2;	/* Do Not Disturb key */
